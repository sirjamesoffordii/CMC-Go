...
const initialCampusData: Campus[] = [
  {
    ...
    people: [
      {
        id: "1-1",
        name: "Sir James Alexander Thomas",
...
export default function App() {
  ...
  const totalPeople =
    stats.going + stats.maybe + stats.notGoing + stats.notInvited;
                ...
                {(() => {
                  ...
                  if (stats.going > 0) {
                    slices.push(
                      <path
                        key="going"
                        d={createPieSlice(currentAngle, goingAngle, "#22c55e")}
                        fill="#22c55e"
                        stroke="white"
                        strokeWidth="1"
                      />
                  ...
                  if (stats.maybe > 0) {
                    slices.push(
                      <path
                        key="maybe"
                        d={createPieSlice(currentAngle, maybeAngle, "#eab308")}
                        fill="#eab308"
                        stroke="white"
                        strokeWidth="1"
                      />
          ...
          <div className="bg-white rounded-lg shadow-sm p-3 transition-shadow hover:shadow-md">
            <div className="space-y-3">
              {campuses.map(campus => (
                <div
                  key={campus.id}
                  className="flex items-center gap-6 py-1 border-b last:border-b-0 group relative"
                >
                  {/* Campus Name */}
                  <CampusNameDropZone
                    campusId={campus.id}
                    ...
                    <div className="w-60 flex-shrink-0 flex items-center gap-2">
                      ...
                      <div className="relative">
                        <button
                          onClick={() =>
                            setOpenMenuId(
                              openMenuId === campus.id ? null : campus.id
                            )
                          }
              ...
              {unassignedPeople.length > 0 && (
                <div className="flex items-start gap-6 py-2 border-b last:border-b-0 group relative">
                  ...
                  <div className="w-60 flex-shrink-0 flex items-center gap-2">
                    ...
                    {/* Spacer for kebab menu alignment */}
                  ...
                  <CampusDropZone
                    ...
                    onDrop={handleCampusRowDrop}
                  >
                    {sortPeopleByStatus(unassignedPeople).map(
                      (person, index) => (
                        <DroppablePerson
                          key={person.id}
                          person={person}
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setPersonForm({ ...personForm, need: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setPersonForm({ ...personForm, spouse: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setPersonForm({ ...personForm, kids: e.target.value })
                  }
        ...
        >
          <DialogContent aria-describedby={undefined}>
            ...
            <DialogFooter>
              ...
              <Button type="button" onClick={handleUpdateCampus}>
                Update Campus
              </Button>
            </DialogFooter>
          </DialogContent>
