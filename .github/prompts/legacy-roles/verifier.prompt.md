...
- `AGENTS.md`
- Your role definition: `.github/agents/legacy-roles/verifier.agent.md`
...
- Your role definition: `.github/agents/legacy-roles/verifier.agent.md` (read other role files only if needed for handoffs/deconfliction)
...
Every time you act as Verifier, **re-read** `.github/agents/legacy-roles/verifier.agent.md` first.
