            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Environment variables are managed by the Manus platform.
                  Sensitive values are masked for security. To modify
                  configuration, use the Manus Management UI Settings panel.
                </p>
              </div>
            </div>
          </CardContent>
