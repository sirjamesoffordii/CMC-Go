            ...
            <div className="flex flex-wrap gap-2">
              {presetColors.map(color => (
                <button
                  ...
                  className={`min-w-11 min-h-11 w-11 h-11 rounded-lg border-2 transition-all ${
                    bgColor === color.value
              ...
              <label className="min-w-11 min-h-11 w-11 h-11 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center cursor-pointer hover:border-gray-400">
                <input
                  type="color"
                  value={bgColor}
          ...
          <div>
            ...
            <div className="flex items-center gap-1 p-2 bg-gray-100 rounded-t-lg border border-b-0 border-gray-200">
              <button
                ...
                className={`min-h-11 min-w-11 p-2 rounded hover:bg-gray-200 flex items-center justify-center ${editor?.isActive("bold") ? "bg-gray-300" : ""}`}
                title="Bold (Ctrl+B)"
              >
              ...
              <button
                ...
                className={`min-h-11 min-w-11 p-2 rounded hover:bg-gray-200 flex items-center justify-center ${editor?.isActive("italic") ? "bg-gray-300" : ""}`}
                title="Italic (Ctrl+I)"
              >
              ...
              <button
                ...
                className={`min-h-11 min-w-11 p-2 rounded hover:bg-gray-200 flex items-center justify-center ${editor?.isActive("underline") ? "bg-gray-300" : ""}`}
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="min-h-11 px-2 py-2 rounded hover:bg-gray-200 flex items-center gap-1 text-sm">
