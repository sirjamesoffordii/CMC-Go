...
export function ShareModal({ open, onClose }: ShareModalProps) {
    ...
    return (
      ...
      >
        <div className="space-y-4 pt-2">
          <div className="flex items-center gap-2.5 text-lg font-bold text-black tracking-tight">
          ...
          <div className="border border-neutral-200 rounded-xl overflow-hidden">
              ...
              <div className="flex items-center gap-1">
                {isMessageModified && (
                  <button
                    ...
                    className="flex items-center gap-1 text-[11px] text-neutral-400 hover:text-red-600 px-2 py-1 rounded-md hover:bg-red-50 transition-colors"
                  >
            ...
            <div className="p-4 bg-white">
              {isEditing ? (
                <div className="space-y-2">
                  <Textarea
                    ...
                    className="min-h-[160px] text-sm resize-none border-neutral-200 focus:border-red-300 focus:ring-red-200 rounded-lg"
                  />
                  <p className="text-[11px] text-neutral-400 tabular-nums text-right">
              ...
              <p className="mt-3 pt-3 border-t border-neutral-100 text-xs text-neutral-400 font-mono">
                {siteUrl}
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-3 text-neutral-400 uppercase tracking-widest font-medium text-[10px]">
                Share via
              </span>
            </div>
          </div>

          {/* Share Options Grid — at the bottom */}
          <div className="grid grid-cols-3 gap-3">
            {/* Email */}
            <button
              onClick={handleEmailShare}
              className="flex flex-col items-center gap-2 p-3 rounded-xl border border-transparent hover:border-neutral-200 hover:shadow-sm transition-all group"
            >
              <div className="w-11 h-11 rounded-full bg-neutral-100 group-hover:bg-red-50 flex items-center justify-center transition-colors">
                <Mail className="w-5 h-5 text-neutral-600 group-hover:text-red-600 transition-colors" />
              </div>
            ...
            >
              <div className="w-11 h-11 rounded-full bg-neutral-100 group-hover:bg-red-50 flex items-center justify-center transition-colors">
                <MessageCircle className="w-5 h-5 text-neutral-600 group-hover:text-red-600 transition-colors" />
              </div>
              <span className="text-xs font-medium text-neutral-600 group-hover:text-black transition-colors">
                Text
              </span>
            ...
            >
              <div className="w-11 h-11 rounded-full bg-neutral-100 group-hover:bg-red-50 flex items-center justify-center transition-colors">
                <svg
                  className="w-5 h-5 text-neutral-600 group-hover:text-red-600 transition-colors"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
            ...
            <button
              ...
              className="relative flex flex-col items-center gap-2 p-3 rounded-xl border border-transparent hover:border-neutral-200 hover:shadow-sm transition-all group"
            >
              <div className="w-11 h-11 rounded-full bg-neutral-100 group-hover:bg-red-50 flex items-center justify-center transition-colors">
                <svg
                  className="w-5 h-5 text-neutral-600 group-hover:text-red-600 transition-colors"
  ...
  return (
    <Dialog open={open} onOpenChange={isOpen => !isOpen && onClose()}>
      <DialogContent className="max-w-md max-h-[85dvh] sm:max-h-[90vh] overflow-y-auto w-[calc(100vw-32px)] sm:w-auto bg-white border-0 shadow-2xl rounded-2xl p-0">
        {/* Header */}
        <DialogHeader className="px-6 pt-6 pb-0">
          <DialogTitle className="flex items-center gap-2.5 text-lg font-bold text-black tracking-tight">
            <div className="w-8 h-8 rounded-full bg-red-600 flex items-center justify-center">
              <Share2 className="w-4 h-4 text-white" />
            </div>
            Share CMC Go
