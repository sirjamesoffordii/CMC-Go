...
export function ShareModal({ open, onClose }: ShareModalProps) {
  ...
  const handleEmailShare = () => {
    const subject = encodeURIComponent(
      "Check out CMC Go - Coordinate toward CMC together"
    );
  ...
  const handleSMSShare = () => {
    ...
    const messageToUse =
      customMessage.length > 300 ? SHORT_MESSAGE : customMessage;
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-2">
              ...
              <p className="text-xs text-blue-700">
                ...
                inviting people to CMC. Use this to help other leaders
                coordinate and track invitations together.
              </p>
            </div>
          ...
          {!isEditing && (
            <div className="p-3 bg-gray-50 rounded-lg">
              ...
              >
                <span>
                  Message Preview {isMessageModified && "(Customized)"}
                </span>
                {showFullPreview ? (
              ...
              <p
                className={`text-xs text-gray-600 whitespace-pre-line ${showFullPreview ? "" : "line-clamp-3"}`}
              >
                {customMessage}
              </p>
            </div>
