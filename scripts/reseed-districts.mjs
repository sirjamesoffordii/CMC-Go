...
const districtsData = [
  ...
  {
    name: "Northern Cal-Nevada",
    svgPathId: "NorthernCal-Nevada",
    regionName: "Big Sky",
  },
  ...
  {
    name: "North Dakota",
    svgPathId: "NorthDakota",
    regionName: "Great Plains North",
  },
  {
    name: "South Dakota",
    svgPathId: "SouthDakota",
    regionName: "Great Plains North",
  },
  ...
  {
    name: "Wisconsin-North Michigan",
    svgPathId: "Wisconsin-NorthMichigan",
    regionName: "Great Plains North",
  },
  ...
  { name: "Kansas", svgPathId: "Kansas", regionName: "Great Plains South" },
  {
    ...
    svgPathId: "NorthernMissouri",
    regionName: "Great Plains South",
  },
  {
    name: "Southern Missouri",
    svgPathId: "SouthernMissouri",
    regionName: "Great Plains South",
  },
  ...
  {
    name: "South Carolina",
    svgPathId: "SouthCarolina",
    regionName: "Southeast",
  },
  {
    name: "North Carolina",
    svgPathId: "NorthCarolina",
    regionName: "Southeast",
  },
  ...
  // Florida
  {
    name: "Peninsular Florida",
    svgPathId: "PeninsularFlorida",
    regionName: "Florida",
  },
...
async function reseedDistricts() {
  ...
  try {
    ...
    for (const district of districtsData) {
      ...
      if (!regionId) {
        console.error(
          `✗ Region not found for district: ${district.name} (region: ${district.regionName})`
        );
        continue;
      }
      ...
      console.log(
        `✓ Created district: ${district.name} (svgPathId: ${district.svgPathId}) → ${district.regionName}`
      );
    }
