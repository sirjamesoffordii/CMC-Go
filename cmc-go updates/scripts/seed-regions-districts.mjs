...
const districtsData = [
  ...
  // Great Plains North
  { name: 'North Dakota', svgPathId: 'North Dakota', regionName: 'Great Plains North' },
  { name: 'South Dakota', svgPathId: 'South Dakota', regionName: 'Great Plains North' },
  ...
  { name: 'Wisconsin', svgPathId: 'Wisconsin', regionName: 'Great Plains North' },
  ...
  { name: 'New Hampshire', svgPathId: 'New Hampshire', regionName: 'Northeast' },
  { name: 'Massachusetts', svgPathId: 'Massachusetts', regionName: 'Northeast' },
  ...
  { name: 'South Carolina', svgPathId: 'South Carolina', regionName: 'Southeast' },
  { name: 'North Carolina', svgPathId: 'North Carolina', regionName: 'Southeast' },
  
  // Mid-Atlantic
  { name: 'West Virginia', svgPathId: 'West Virginia', regionName: 'Mid-Atlantic' },
  ...
  { name: 'Pennsylvania', svgPathId: 'Pennsylvania', regionName: 'Mid-Atlantic' },
...
async function seedDatabase() {
  ...
  try {
    ...
    for (const district of districtsData) {
      ...
      console.log(`✓ Created district: ${district.name} → ${district.regionName} (ID: ${result.insertId})`);
    }
