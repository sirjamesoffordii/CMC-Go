        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
          <div className="relative h-[300px]">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              <h1 className="text-5xl font-bold mb-2 drop-shadow-lg">CMC 2026</h1>
              <p className="text-xl drop-shadow-md">Campus Missions Conference</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Friday, July 10, 2026 • 11:30pm CDT</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-600 font-semibold text-lg">Arizona Grand Resort</p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 mb-4">
              The Campus Missions Conference (CMC) is Chi Alpha's premier annual gathering, bringing together 
              students, staff, and leaders from across the nation for a transformative week of worship, teaching, 
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    College students, campus missionaries, directors, and anyone passionate about 
                    reaching campuses for Christ.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Early bird registration opens soon. Contact your campus director for group 
                    rates and scholarship opportunities.
                  </p>
                </div>
              </div>
            </div>
